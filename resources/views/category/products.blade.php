...
<header>
    ...
    <h2 id="caption" style="margin-top: 50px; margin-left: 100px">{{ $category->name }}</h2>
            ...
            <div class="col-md-4">
                <div class="card" style="margin-left: 100px; margin-top: 30px;">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary add-to-cart-btn" data-id="{{ $product->id }}">В корзину</button>
                    </div>
                </div>
            </div>
        @endforeach
